...
/* oxlint-disable jsx-a11y/prefer-tag-over-role -- Field is a reusable composite group; fieldset is reserved for callers grouping related controls. */
...
function hasFieldErrorContent(content: ReactNode): boolean {
  ...
  return content !== 0 && content !== BigInt("") && !Object.is(content, Number.NaN);
}

function getFieldErrorContent(errors: FieldErrorItem[] | undefined): ReactNode {
...
function FieldError({
  ...
  const content = hasFieldErrorContent(children) ? children : getFieldErrorContent(errors);
